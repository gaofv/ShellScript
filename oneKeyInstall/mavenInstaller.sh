...
tar -zxvf /opt/install/apache-maven-3.3.9-bin.tar.gz -C /home/maven


echo "开始配置环境变量"


echo "export MAVEN_HOME=/home/maven/apache-maven-3.3.9" >> /root/.bash_profile

source /root/.bash_profile

echo "export PATH=$PATH:$MAVEN_HOME/bin" >> /root/.bash_profile
